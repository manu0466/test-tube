...
import (
	...
	// cosmwasm-testing
	"github.com/manu0466/desmos-test-tube/result"
	"github.com/manu0466/desmos-test-tube/testenv"
)
...
func InitTestEnv() uint64 {
	...
	env := testenv.NewTestEnv("desmos-1", "udsm")
...
func InitAccount(envId uint64, coinsJson string) *C.char {
	...
	err := env.FundAccount(accAddr, coins)
	if err != nil {
